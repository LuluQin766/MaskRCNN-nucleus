...
class NucleusConfig(Config):
    ...
    # Image mean (RGB)
    # MEAN_PIXEL = np.array([43.53, 39.56, 48.22])  # original
...
class NucleusInferenceConfig(NucleusConfig):
    ...
    # IMAGE_RESIZE_MODE = "pad64"     # original
    # Non-max suppression threshold to filter RPN proposals.
    # You can increase this during training to generate more propsals.
...
def detect(model, dataset_dir, subset):
    ...
    print("Running on {}".format(dataset_dir, "stage2_test_final"))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', required=False,
                        ...
                        default="../../data-science-bowl-2018/",
                        help='Root directory of the dataset')
    # parser.add_argument('--weights', required=True,
    parser.add_argument('--weights', required=False,
                        # metavar="/path/to/weights.h5",
                        default="coco",
                        # default="../../weights/resnet50_weights_tf_dim_ordering_tf_kernels_notop.h5",
                        # metavar="../../weights/resnet50_weights_tf_dim_ordering_tf_kernels_notop.h5",
                        # metavar="coco",
